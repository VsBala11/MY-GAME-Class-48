...
endImage=loadImage("../assets/WinIamge.png")
speedImage=loadImage("../assets/Speed.1.png")
...
function setup() 
{
  ...
  speed=createSprite(random(0,500),random(100,300));
  ...
  start=createSprite(250,400)
  start.addImage(startImage);
  start.visible= true
  start.scale=0.25

  End=createSprite(250,400)
